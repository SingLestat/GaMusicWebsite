<?php
    ...
    try {
        $conn = new PDO("sqlsrv:server = tcp:website-database-server.database.windows.net,1433; Database = Website-DB", "localadmin", "P@ssword12345");
    ...
    $connectionInfo = array("UID" => "localadmin", "pwd" => "P@ssword12345", "Database" => "Website-DB", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
    $serverName = "tcp:website-database-server.database.windows.net,1433";
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <div class="hero-area d-flex align-items-center">
        <!-- Hero Thumbnail -->
        <div class="hero-thumbnail equalize bg-img" style="background-image: url(img/slide-images/Business-image-1-3.jpg);"></div>
    ...
    <div class="sonar-services-area section-padding-100-50">
        <div class="container">
            <div class="row">
                ...
                <!-- Form with action to process information from clicks -->
                <form method="post" action="queryBusiness.php"></form>
                    <!-- Single Services Area -->
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            <!-- <img src="img/core-img/camera.png" alt=""> -->
                            <button name="business_type" type="submit" value="BUSINESS SERVICES" class="btn sonar-btn mt-100">BUSINESS SERVICES</button>
                        </div>
                    </div>
                    <!-- Single Services Area -->
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="600ms">
                            ...
                            <button name="business_type" type="submit" value="COMMERCIAL MUSIC" class="btn sonar-btn mt-100">COMMERCIAL MUSIC</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            <!-- <img src="img/core-img/camera.png" alt=""> -->
                            <button name="business_type" type="submit" value="EDUCATION" class="btn sonar-btn mt-100">EDUCATION</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="900ms">
                            ...
                            <button name="business_type" type="submit" value="FESTIVALS" class="btn sonar-btn mt-100">FESTIVALS</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <button name="business_type" type="submit" value="INDUSTRY OPPORTUNITIES" class="btn sonar-btn mt-100">INDUSTRY OPPORTUNITIES</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="600ms">
                            ...
                            <button name="business_type" type="submit" value="MEDIA" class="btn sonar-btn mt-100">MEDIA</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            <!-- <img src="img/core-img/camera.png" alt=""> -->
                            <button name="business_type" type="submit" value="MUSIC VIDEOS" class="btn sonar-btn mt-100">MUSIC VIDEOS</button>
                        </div>
                    </div>
                    <!-- Single Services Area -->
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="600ms">
                            <!-- <img src="img/core-img/vector.png" alt=""> -->
                            <button name="business_type" type="submit" value="MUSICAL INSTRUMENTS & EQUIPMENT" class="btn sonar-btn mt-100">MUSICAL INSTRUMENTS & EQUIPMENT</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            <!-- <img src="img/core-img/camera.png" alt=""> -->
                            <button name="business_type" type="submit" value="RECORD PRODUCTION, DISTRIBUTION & SALES" class="btn sonar-btn mt-100">RECORD PRODUCTION, DISTRIBUTION & SALES</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="900ms">
                            <!-- <img src="img/core-img/pantone.png" alt=""> -->
                            <button name="business_type" type="submit" value="RECORDING SERVICES" class="btn sonar-btn mt-100">RECORDING SERVICES</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="300ms">
                            <!-- <img src="img/core-img/video-player.png" alt=""> -->
                            <button name="business_type" type="submit" value="TOUR SERVICES" class="btn sonar-btn mt-100">TOUR SERVICES</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-services-area wow fadeInUp" data-wow-delay="600ms">
                            <!-- <img src="img/core-img/browsing.png" alt=""> -->
                            <button name="business_type" type="submit" value="VENUES" class="btn sonar-btn mt-100">VENUES</button>
                        </div>
                    </div>
                </form>
                <!-- End of Form  -->
        ...
        <table class="table table-hover ">
            <thead class="thead-dark">
                ...
                <tbody>
                    <tr>
                            <?php
                                    $bus_category = $_POST['business_type'];
                                    $sql = "SELECT * FROM [Business] WHERE [MUSIC_BUSINESS_CATEGORY] = '$bus_category'";
                                    $stmt = sqlsrv_query( $conn, $sql);
                                    if( $stmt === false ) {
                                        die( print_r( sqlsrv_errors(), true));
                                    }
                                    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
                                        echo "<tr><td>{$row['MUSIC_BUSINESS_CATEGORY']}</td><td>{$row['MUSIC_BUSINESS_SUBCATEGORY']}</td><td>{$row['CAPACITY']}</td><td>{$row['SORT']}</td><td>{$row['NOTATION']}</td></tr>";
                                    }
