...
<head>
    ...
    <!-- Title  -->
    <title>Business & Services Result</title>
...
<body>
    ...
    <div class="mainMenu d-flex align-items-center justify-content-between">
        ...
        <!-- Nav -->
        <div class="sonarNav" data-wow-delay="1s">
            <nav>
                <ul>
...
<div class="container">
    <br>
    <br>
    <h1>BUSINESS SERVICE INFORMATION</h1>
    <br>
 
    <div class="backend-content">
        <table class="table table-hover ">
            <thead class="thead-dark">
                <th>MUSIC BUSINESS CATEGORY</th>
                <th>MUSIC BUSINESS SUBCATEGORY</th>
                <th>CAPACITY</th>
                <th>SORT</th>
                <th>NOTATION</th>
            </thead>
